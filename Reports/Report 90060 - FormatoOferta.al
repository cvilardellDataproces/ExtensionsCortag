report 90060 FormatoOferta
{
    // version NAVW110.00.00.14199,NAVES10.00.00.14199

    DefaultLayout = RDLC;
    RDLCLayout = './Reports/FormatoOferta.rdlc';
        ...
        dataitem("Sales Header";"Sales Header")
        {
            ...
            begin
                ...
                IF "Ship-to Address 2" <> '' THEN BEGIN
                  ...
                  CustAddr[10] := Vend."E-Mail";
                  CustAddr[11] := Vend."Phone No.";
                  CustAddr[12] := FORMAT("Due Date");
                 END
                ELSE BEGIN
                  ...
                  CustAddr[9] := Vend."E-Mail";
                  CustAddr[10] := Vend."Phone No.";
                  CustAddr[11] := FORMAT("Due Date");
                END;
                ...
                LinPedido.SETRANGE("Document Type",LinPedido."Document Type"::Quote);
    ...
    var
        Text004 : TextConst Comment='%1 = Document No.',ENU='SALES QUOTE %1',ESP='OFERTA %1',FRA='DEMMANDE%1';
        ...
        OrderNoCaptionLbl : TextConst ENU='QUOTE No.:',ESP='Nº OFERTA:',FRA='Nº Commande';
        ...
        text003 : TextConst ENU='Date:',ESP='Fecha oferta:',FRA='Date Order:';
        ...
        text014 : TextConst ENU='Due date quote:',ESP='Fecha Vencimiento:',FRA='Nº commande du client:';
        ...
        text016 : TextConst ENU='ACCEPTANCE AND SIGNATURE',ESP='ACEPTACIÛN Y FIRMA';
        text017 : TextConst ENU='E-mail Agent:',ESP='E-Mail comercial:';
        text018 : TextConst ENU='ph. agent:',ESP='Tel. comercial:';
        text011 : Text[30];
