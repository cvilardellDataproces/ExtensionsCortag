report 90095 "Formato Abono Cortag"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Formato Abono Cortag.rdlc';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header";"Sales Cr.Memo Header")
        {
            ...
            column(ImporteTotalFacCaption;ImporteTotalFacCaptionLbl)
            {
            }
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(PostingDate_SalesInvHdr;FORMAT("Sales Cr.Memo Header"."Posting Date"))
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line";"Sales Cr.Memo Line")
                    {
                        ...
                        column(LineDisc_SalesInvoiceLine;"Sales Cr.Memo Line"."Line Discount %")
                        {
                        }
                        ...
                        column(Type_SalesInvoiceLine;FORMAT("Sales Cr.Memo Line".Type))
                        {
                        }
                        ...
                        column(ShipmentNo_SalesInvLine;'')
                        {
                        }
                        column(ShipDate_SalesInvLine;FORMAT("Sales Cr.Memo Line"."Shipment Date"))
                        {
                        }
                        ...
                        begin
                            ...
                            //-CLIP4.0
                            //SaleShipHead.RESET;
                            //IF NOT SaleShipHead.GET("Sales Cr.Memo Line"."Shipment No.") THEN
                            //  SaleShipHead.INIT;
                            ...
                            IF "Inv. Discount Amount" <> 0 THEN BEGIN
                              DTOFACTURA.RESET;
                              DTOFACTURA.SETRANGE(DTOFACTURA.Code,"Sales Cr.Memo Header"."Sell-to Customer No.");
    ...
    var
        ...
        Text004 : TextConst ENU='Corrective invoice',ESP='FACTURA CORRECTIVA',FRA='FACTURE';
        ...
        InvoiceNoCaptionLbl : TextConst ENU='INVOICE No.:',ESP='ABONO Nº:',FRA='FACTURE Nº:';
        ...
        ImporteTotalFacCaptionLbl : TextConst ENU='TOTAL AMOUNT €',ESP='TOTAL FRA. EUROS',FRA='MONTANT TOTAL';
    ...
    var
        ...
        SalesShipmentHeader : Record "Return Receipt Header";
    ...
    begin
        ...
        SalesShipmentLine.SETCURRENTKEY("Return Order No.","Return Order Line No.");
        SalesShipmentLine.SETRANGE("Return Order No.","Sales Cr.Memo Header"."Return Order No.");
        SalesShipmentLine.SETRANGE("Return Order Line No.",SalesInvoiceLine."Line No.");
    ...
    procedure CorrectShipment(var SalesShipmentLine : Record "Return Receipt Line");
    var
    ...
    var
        ...
        SalesShipmentLine : Record "Sales Cr.Memo Line";
    begin
    ...
    var
        SalesInvHead2 : Record "Sales Cr.Memo Header";
    ...
    local procedure CountLines(SIL : Record "Sales Cr.Memo Line");
    begin
        //-CLIP10.0
        WITH SIL DO BEGIN
          LineCounter += 1;
