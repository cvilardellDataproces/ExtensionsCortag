report 90077 "Factura ProForma Cortag"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Factura ProForma Cortag.rdlc';

    CaptionML = ENU='Sales - Invoice',
                ESP='ProForma Factura';
    ...
    dataset
    {
        dataitem("Sales Header";"Sales Header")
        {
            ...
            RequestFilterHeadingML = ENU='Draft Invoice',
                                     ESP='Borrador de facturas';
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(PostingDate_SalesInvHdr;FORMAT("Sales Header"."Posting Date"))
                    {
                    }
                    ...
                    dataitem("Sales Line";"Sales Line")
                    {
                        ...
                        column(ShipmentNo_SalesInvLine;"Sales Line"."Shipment No.")
                        {
                        }
                        column(ShipDate_SalesInvLine;FORMAT("Sales Line"."Shipment Date"))
                        {
                        }
                        column(ExternalDocNo_SalesShipHead;SaleShipHead."External Document No.")
                        {
                        }
                        ...
                        begin
                            ...
                            //-CLIP4.0
                            SaleShipHead.RESET;
                            IF NOT SaleShipHead.GET("Sales Line"."Shipment No.") THEN
                              SaleShipHead.INIT;
                            ...
                            IF "Inv. Discount Amount" <> 0 THEN BEGIN
                              DTOFACTURA.RESET;
                              DTOFACTURA.SETRANGE(DTOFACTURA.Code,"Sales Header"."Sell-to Customer No.");
                            ...
                            IF "Sales Line"."Line Discount %" <> 0 THEN BEGIN
                              IF DescCliente.GET("Sales Header"."Customer Disc. Group") THEN
                                TextDescuento := DescCliente.Description
                              ELSE
                                TextDescuento := FORMAT("Sales Line"."Line Discount %");
                            END;
                            //CVP fi
            ...
            begin
                ...
                IF "Sales Header"."Currency Code" = '' THEN BEGIN
                  ...
                  END
                ELSE BEGIN
                  IF DivisaAux.GET("Sales Header"."Currency Code") THEN BEGIN
                    SimbDivisa := DivisaAux.Symbol;
                    textDivisa := "Sales Header"."Currency Code";
                  END;
                END;

                //Comentarios.SETFILTER(Comentarios."No.","Sales Header"."No.");
                //IF Comentarios.FIND THEN;
            end;
        }
    }
    ...
    begin
        ...
        CompanyInfo2.CALCFIELDS(Picture); //CLIP4.0
    end;
    ...
    var
        ...
        Text004 : TextConst ENU='PROFORMA INVOICE',ESP='FACTURA PROFORMA',FRA='FACTURE';
        ...
        ConceptocaptionLbl : TextConst ENU='DESCRIPTION',ESP='DESCRIPCION',FRA='CODE CATALOGUE';
        ...
        PersonaContactoCaptionLbl : TextConst ENU='FAO:',ESP='Attn:';
        DireccionEnvioCaptionLbl : TextConst ENU='INVOICE ADDRESS:',ESP='DIRECCION FACTURACION:';
        SimbDivisa : Text[10];
    ...
    procedure ShowCashAccountingCriteria(SalesInvoiceHeader : Record "Sales Header") : Text;
    var
    ...
    var
        SalesInvHead2 : Record "Sales Header";
    ...
    begin
        ...
        //SalesInvHead2.GET("Invoice",DocNo);
        SalesInvHead2.SETRANGE(SalesInvHead2."Document Type", SalesInvHead2."Document Type"::Invoice);
        SalesInvHead2.SETRANGE(SalesInvHead2."No.", DocNo);
        IF SalesInvHead2.FINDFIRST THEN;
    ...
    local procedure CountLines(SIL : Record "Sales Line");
    begin
        //-CLIP10.0
        WITH SIL DO BEGIN
          LineCounter += 1;
